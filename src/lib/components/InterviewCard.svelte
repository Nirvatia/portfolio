...
>
	<div class="min-w-0">
		...
		{#if card.answer}
			<p class="dropcap font-serif text-[clamp(21px,4.6vw,38px)] leading-[1.3] tracking-[-0.01em]">
	...
	{#if card.marginalia}
		<aside
			...
			class="mt-[clamp(34px,5vh,48px)] flex flex-col text-right font-mono text-[11px] leading-[1.8] text-mut max-md:hidden"
		>
